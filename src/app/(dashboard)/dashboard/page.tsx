...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6 w-full min-w-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 w-full min-w-0">
        ...
        >
          <div className="flex items-start justify-between">
            <p className="text-[11px] font-black uppercase tracking-wider text-slate-400 truncate">Health Score</p>
      ...
      {/* Interactive Cloud Storage Architecture Flow Diagram */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full min-w-0">
          ...
          <ChartCard title="Where Your Cloud Money Goes" subtitle="Direct cost allocation across storage classes and egress">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 w-full min-w-0">
              {costBreakdown.map(item => (
                <div
                  key={item.label}
                  className="flex items-center gap-3.5 p-3.5 rounded-2xl border border-slate-700/80 bg-slate-900/60 hover:bg-slate-800/80 hover:shadow-lg transition-all group min-w-0"
                >
                  <div
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <span className="text-xs font-black text-white ml-2 flex-shrink-0">{item.amount}</span>
                    </div>
        ...
        <div className="space-y-4 min-w-0">
          ...
          <div className="card p-5 card-glow-cyan min-w-0">
      ...
      <div className="card w-full min-w-0">
        <div className="flex items-center justify-between px-6 py-4.5 border-b border-slate-700/80 flex-wrap gap-2">
          <div>
          ...
          <button onClick={() => router.push('/recommendations')} className="btn-secondary text-xs flex-shrink-0">
            View All Actions →
          </button>
        </div>
